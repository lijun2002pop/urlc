<template>
    <a-layout style="min-height: 100vh">
      <a-layout-sider v-model:collapsed="collapsed" collapsible>
        ...
        <a-menu v-for="(menu,index) in menu_list" v-model:selectedKeys="selectedKeys" theme="dark" mode="inline" :key="index">
          ...
          <a-sub-menu v-else :keys="menu.id">
            <template #title>
              <span>
                <user-outlined/>
                <span>{{ menu.title }}</span>
  ...
  export default defineComponent({
    ...
    data() {
      return {
        ...
        menu_list: [
          {
            id: 1, icon: 'mail', title: '展示中心', tube: '', 'menu_url': '/urils/about', children: []
          },
          {
            id: 2, icon: 'mail', title: '音乐', 'menu_url': '/urils/music', children: []
          },
          {
            id: 3, icon: 'bold', title: '主机管理', tube: '', menu_url: '/urils/host', children: []
          },
          {
