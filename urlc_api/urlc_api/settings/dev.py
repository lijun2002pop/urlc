"""
Django settings for urlc_api project.
...
SECRET_KEY = "django-insecure-7$c(88aj3#_9&)@38nrlay3qkifpdj%3+$*rf4l6a6a5bnmmkr"
...
MIDDLEWARE = [
    ...
    "urlc_api.middlewares.logs.LogMiddleWare",

]

ROOT_URLCONF = "urlc_api.urls"
...
WSGI_APPLICATION = "urlc_api.wsgi.application"
...
AUTH_USER_MODEL = 'users.User'  #  其中user为app名称，User为模型类名称
